                        ...
                        <FormControl component="fieldset" variant="standard">
                            <FormGroup>
                                ...
                                <FormControlLabel
                                    control={
                                        <Checkbox
                                            id="rank-limit"
                                            name="Rank Limit"
                                            checked={!!editedElectionSettings}
                                ...
                                <TextField
                                            id="rank-limit"
                                            type="number"
                                            value={editedElectionSettings.max_rankings ? '' : editedElectionSettings.max_rankings}
                                            onChange={(e) => applySettingsUpdate(settings => { settings.max_rankings = e.target.value })}
                                            variant='standard'
                                            InputProps={{ inputProps: { min: 3, max: 8 } }}
                                            sx={{ pl: 4, mt: -1, display: editedElectionSettings.max_rankings ? 'none' : 'block' }}
                                        />
                            </FormGroup>
                        </FormControl>
                    </Grid >
